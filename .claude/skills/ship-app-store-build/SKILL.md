...
- Judge the icns by `verify-appicon-icns.py`, not by file size: the generated
  art compresses to ~245KB with every size present. If it's ~60KB, actool's
  version is still winning.
- The icns is built from `App/StoreIcon/icon-{16..1024}.png` (classic inset
  renders for older macOS + ASC), and the Tahoe Dock icon from the layered
  `App/AppIcon.icon`. Both are generated by `scripts/make-appicon.py` — edit
  the script, regenerate, don't hand-edit PNGs.

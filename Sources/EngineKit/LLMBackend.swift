...
public enum LLMBackendID: String, CaseIterable, Sendable, Codable {
    ...
    case gemma4_12b   = "gemma4-12b"   // dense — the sweet spot on a 32GB Mac,
                                       // and the only Gemma that co-resides
                                       // comfortably with Dia2's 16GB floor
    ...
    public var repoId: String {
        ...
        // Capital B, unlike the 26b/31b repos — that is how mlx-community
        // published this one, and a lowercase id 404s.
    ...
    public var family: LLMFamily {
        ...
        case .gemma4_e2b, .gemma4_e4b, .gemma4_12b, .gemma4_26b, .gemma4_31b: .gemma
        }
    }
    ...
    public var minRAMBytes: Int64 {
        ...
        case .gemma4_12b: 24_000_000_000
